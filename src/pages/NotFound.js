...
const NotFound = () => {
  ...
  const cardHeight = isInsideStore ? '70vh' : '80vh';
    ...
    <div style={{ 
      ...
      <div style={{ maxWidth: 1200, width: '100%', margin: '0 auto' }}>
        ...
        <div style={{ 
          ...
          <h2 style={{ margin: '0 0 16px 0', fontSize: 24, fontWeight: 600, color: 'var(--color-text)' }}>
            Что-то пошло не так
          </h2>
          
          <p style={{ margin: '0 0 32px 0', fontSize: 16, color: 'var(--color-text-secondary)', lineHeight: 1.5 }}>
